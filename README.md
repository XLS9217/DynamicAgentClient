...
```bash
pip install "dynamic-agent-client @ git+https://github.com/XLS9217/DynamicAgentClient.git"
```
...
```bash
uv add "dynamic-agent-client @ git+https://github.com/XLS9217/DynamicAgentClient.git"
```
